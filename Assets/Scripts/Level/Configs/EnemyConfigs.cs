...
public class EnemyConfig : ScriptableObject
{
    ...
    [Header("Distracted Rush")]
    [Tooltip("Speed multiplier applied to moveSpeed when rushing to a distraction (1 = same as chase speed).")]
    public float distractedRushMultiplier = 1.5f;
}